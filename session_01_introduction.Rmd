...
1. Try using the outline menu (`r knitr::include_graphics("img/outline.png")`) in the top right-hand corner of the source pane to get an overview of this source code
