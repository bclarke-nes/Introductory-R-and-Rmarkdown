...
There's a quick reference, and a couple of exercises, at the foot of this section. But to give you an idea of what Rmarkdown can do, we can have a look at the introductory materials for this demonstration. While the introductory materials are completely static - apart from the date at the top nothing changes without us manually updating it - it's still a useful demonstration of the kinds of formatting that we can do in Rmarkdown. Let's have a quick look at the Rmarkdown code for this training report now to see what it's like:

### Rmarkdown in this report

1. Try to find the Rmarkdown code corresponding to this text in the source code pane. We're currently at about line 130 in the source code. Once you've found this section, have a look around to spot:
...
# but the name of the tibble will be different this time. You can check to see whether your code has worked by uncommenting the line below:
...
```{r graph chunk 3, echo=T, fig.align='left', fig.height=2, fig.width=2, message=FALSE, warning=FALSE}
...
```{r graph chunk 4, echo=T, fig.align='left', fig.height=2, fig.width=2, message=FALSE, warning=FALSE}
...
```{r graph chunk 5, echo=T, fig.align='left', fig.height=2, fig.width=2, message=FALSE, warning=FALSE}
