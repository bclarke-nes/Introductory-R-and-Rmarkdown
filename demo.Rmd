...
1. First, edit the `data.csv` file. To do this, click on the `data.csv` file in the `Files` pane, and select `View File`. This should open the data file in the code pane. 
