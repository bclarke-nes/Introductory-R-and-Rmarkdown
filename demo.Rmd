...
output:
  ...
  word_document:
    ...
    toc_depth: '2'
---
# Resource aims and objectives 

To give an introduction to writing dynamic reports using RStudio Cloud. Designed for those without previous programming experience, this [approximately] 2 hour interactive session uses R and Rmarkdown to put together a simple dynamic report. The session is specifically designed for a health and care audience, and will:
