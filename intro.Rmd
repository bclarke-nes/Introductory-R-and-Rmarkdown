...
+ **investment**. Particularly if you are new to this kind of work, writing a new dynamic report takes longer than a traditional report the first time. There's plenty to learn, and it can be hard to find that space to rework an existing process.
...
+ **Information Governance concerns** about data management.
+ **novelty**. Changing processes is often controversial, with a degree of resistance. QI methods might be helpful if you think this is likely to be a substantial concern for your project.
